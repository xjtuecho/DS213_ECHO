/******************** (C) COPYRIGHT 2014 e-Design Co., Ltd. ********************
  USB_scsi.c STM32 USB Disk Ver 2.0       Author : MCD Application Team & bure
*******************************************************************************/
#include "USB_scsi.h"
#include "USB_bot.h"
#include "usb_regs.h"
...
extern uc8 Inquiry_Str[];
extern u32 SectorSize, SectorAmnt;
...
{
  ReadFormatCapacity[ 4] = (u8)(SectorSize >> 24);
  ReadFormatCapacity[ 5] = (u8)(SectorSize >> 16);
  ReadFormatCapacity[ 6] = (u8)(SectorSize >>  8);
  ReadFormatCapacity[ 7] = (u8)(SectorSize);

  ReadFormatCapacity[ 9] = (u8)(SectorSize >> 16);
  ReadFormatCapacity[10] = (u8)(SectorSize >>  8);
  ReadFormatCapacity[11] = (u8)(SectorSize);
...
{
  ReadCapacity10_Data[0] = (u8)(SectorAmnt >> 24);
  ReadCapacity10_Data[1] = (u8)(SectorAmnt >> 16);
  ReadCapacity10_Data[2] = (u8)(SectorAmnt >>  8);
  ReadCapacity10_Data[3] = (u8)(SectorAmnt);

  ReadCapacity10_Data[4] = (u8)(SectorSize >>  24);
  ReadCapacity10_Data[5] = (u8)(SectorSize >>  16);
  ReadCapacity10_Data[6] = (u8)(SectorSize >>  8);
  ReadCapacity10_Data[7] = (u8)(SectorSize);
...
u8 SCSI_Address_Management(u8 Cmd , u32 LBA , u32 BlockNbr)
{
  ...
  if (CBW.dDataLength != BlockNbr*SectorSize){
    if (Cmd == SCSI_WRITE10) Bot_Abort(BOTH_DIR);
